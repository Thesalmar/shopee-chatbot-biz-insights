...
- Test individual components using the testing commands
...
- LINE Messaging API for bot platform
- OpenAI GPT for AI capabilities
- Shopee Open Platform for e-commerce integration
...
Built with ❤️ for Shopee sellers who want to leverage AI for business growth
